...
public class Country implements Parcelable {
    ...
    public List<String> getCallingCodes() {
        return callingCodes != null ? callingCodes : new ArrayList<String>();
    }
    ...
    public List<String> getCurrencies() {
        return currencies != null ? currencies : new ArrayList<String>();
    }
    ...
    public List<String> getLanguages() {
        return languages != null ? languages : new ArrayList<String>();
    }
